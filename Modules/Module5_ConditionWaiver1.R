...
for(i in 1:nrow(wb))   {  
  ...
  if (length(start) == 1 ){
    ...
    test <- lines[start:(start+70)]
    res<-data.frame(str_detect(test,"1.4. Condition:"))
    colnames(res)<-"Result"
    res<-subset(res,res$Result==TRUE)
    if ( nrow(res) > 0 ){
    ...
    test <- lines[start:(start+70)]
    res<-data.frame(str_detect(test,"1.5. Condition:"))
    colnames(res)<-"Result"
    res<-subset(res,res$Result==TRUE)
    if ( nrow(res) > 0 ){
    ...
    test <- lines[start:(start+70)]
    res<-data.frame(str_detect(test,"1.6. Condition:"))
    colnames(res)<-"Result"
    res<-subset(res,res$Result==TRUE)
    if ( nrow(res) > 0 ){
    ...
    test <- lines[start:(start+70)]
    res<-data.frame(str_detect(test,"1.7. Condition:"))
    colnames(res)<-"Result"
    res<-subset(res,res$Result==TRUE)
    if ( nrow(res) > 0 ){
    ...
    test <- lines[start:(start+70)]
    res<-data.frame(str_detect(test,"1.8. Condition:"))
    colnames(res)<-"Result"
    res<-subset(res,res$Result==TRUE)
    if ( nrow(res) > 0 ){
    ...
    test <- lines[start:(start+70)]
    res<-data.frame(str_detect(test,"1.9. Condition:"))
    colnames(res)<-"Result"
    res<-subset(res,res$Result==TRUE)
    if ( nrow(res) > 0 ){
